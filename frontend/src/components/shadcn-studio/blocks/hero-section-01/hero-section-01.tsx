  ...
  return (
    <section className='flex min-h-[calc(100dvh-4rem)] flex-1 flex-col justify-between gap-12 overflow-x-hidden pt-8 sm:gap-16 sm:pt-16 lg:gap-24 lg:pt-24'>
      ...
      <div className='mx-auto flex max-w-7xl flex-col items-center gap-8 px-4 text-center sm:px-6 lg:px-8'>
        ...
        <h1 className='mt-16 text-3xl leading-[1.29167] font-bold text-balance sm:text-4xl lg:text-5xl'>
          Discover Amazing {' '}
          ...
          <br />
          Learn, Connect & Create Together          
        </h1>

        <p className='text-muted-foreground'>
          Discover and book handcrafted workshops — from pottery to pastry, photography to floral design. 
          <br />
